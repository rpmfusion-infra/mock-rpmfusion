...
#baseurl=https://download1.rpmfusion.org/nonfree/el/next/$releasever/$basearch/
...
#baseurl=https://download1.rpmfusion.org/nonfree/el/next/testing/$releasever/$basearch/
